...
class CatalogueApplication(Application):
    ...
    stock_alert_view = get_class('dashboard.catalogue.views',
                                 'StockAlertListView')
    # manufacturer views
    manufacturer_create_view = get_class('apps.dashboard.catalogue.views',
                                          'ManufacturerCreateView')
    manufacturer_update_view = get_class('apps.dashboard.catalogue.views',
                                          'ManufacturerUpdateView')
    manufacturer_list_view = get_class('apps.dashboard.catalogue.views',
                                        'ManufacturerListView')
    manufacturer_delete_view = get_class('apps.dashboard.catalogue.views',
    ...
    def get_urls(self):
        urls = [
            ...
            # manufacturer urls
            url(r'^manufacturer/create/$',
                self.manufacturer_create_view.as_view(),
                name='catalogue-manufacturer-create'),
            url(r'^manufacturers/$',
                self.manufacturer_list_view.as_view(),
                name='catalogue-manufacturer-list'),
            url(r'^manufacturer/(?P<pk>\d+)/update/$',
                self.manufacturer_update_view.as_view(),
                name='catalogue-manufacturer-update'),
            url(r'^manufacturer/(?P<pk>\d+)/delete/$',
                self.manufacturer_delete_view.as_view(),
                name='catalogue-manufacturer-delete'),
        ]
